...
a("formControlHashTemplate",function(a){"use strict";var b=this,c=(b.$helpers,b.$string),d=a.keyControlTemplate,e=a.controlTemplate,f="";return f+='<span class="form-array-li w45p">',f+=c(d),f+='</span> <span class="form-array-li w45p">',f+=c(e),f+="</span>",new k(f)}),/*v:7*/
a("formControlInputConfigTemplate",function(a){"use strict";var b=this,c=(b.$helpers,b.$escape),d=a.listitem,e=a.p,f=a.data,g=a.options,h=a.flag,i="";return i+='<input data-listitem="',i+=c(d),i+='" id="formitem-',i+=c(e),i+='" class="formitem-control formitem-input ',i+=c(f.classname.control),i+='" style="',i+=c(f.style.control),i+='" placeholder="',i+=c(f.placeholder),i+='" ',i+=c(g.status),i+=" ",i+=c(f.validation),i+=' data-flag="',i+=c(h),i+='" ',i+=c(f.disabled),i+=" ",i+=c(f.attr),i+=' data-order="',i+=c(f.order),i+='" type="',i+=c(f.control),i+='" value="',i+=c(f.value),i+='">',new k(i)}),/*v:7*/
a("formControlInputTemplate",function(a){"use strict";var b=this,c=(b.$helpers,b.$escape),d=a.listitem,e=a.p,f=a.data,g=a.options,h=a.flag,i="";return i+='<input data-listitem="',i+=c(d),i+='" id="formitem-',i+=c(e),i+='" class="formitem-control formitem-input ',i+=c(f.classname),i+='" style="',i+=c(f.style),i+='" ',i+=c(g.status),i+=' data-flag="',i+=c(h),i+='" placeholder="',i+=c(f.placeholder),i+='" ',i+=c(f.validation),i+=" ",i+=c(f.attr),i+=' value="',i+=c(f.value),i+='" type="',i+=c(f.control),i+='">',new k(i)}),/*v:7*/
a("formControlObjectTemplate",function(a){"use strict";var b=this,c=(b.$helpers,b.$escape),d=a.p,e=a.stringifyVal,f="";return f+='<a href="javascript:;" class="form-icon form-item-detail formitem-control" for="formitem-',f+=c(d),f+='" data-mf-val="',f+=c(e),f+='" title="\u8be6\u7ec6\u8bbe\u5b9a"><i class="mf-iconfont">&#xf00e1;</i></a>',new k(f)}),/*v:9*/
    ...
    var mf = (function() {
        return {
            ...
            _translateLabel:function(valin,hasCloseTag,p,options){
                var generatedHtml = '';
                var labelTemplate = '';
                labelTemplate = magicformTmpl.template('formLabelTemplate')({
                    data: valin,
                    p: p
                });
                ...
                generatedHtml = magicformTmpl.template('formControlTemplate')({data:valin,
            ...
            _translateControl:function(valin,hasCloseTag,p,options,additionnal){
                ...
                //判断字段类型
                 //hash值
                if(valin.hash){
                    controlTemplate = magicformTmpl.template('formControl'+type+'Template')({data:valin,p:p,options:options,listitem:'listitem'});
                    if(options.tmplprocess){
                        controlTemplate = options.tmplprocess(controlTemplate);
                    }

                    generatedHtml = magicformTmpl.template('formControlHashTemplate')({
                    ...
                    for(var j=filteredValin.length-1;j>=0;j--){
                        arrayHtml += magicformTmpl.template('formArrayControlItemTemplate')({
                            controlTemplate:this._translateControl(filteredValin[j],hasCloseTag,p,options,'listitem'),
                            editable:editable
                        });
                    }
                    generatedHtml = magicformTmpl.template('formArrayTemplate')({
                        data:valin,
                        editable : editable,
                        notNew : notNew,
                    ...
                    //key-object
                    generatedHtml =  magicformTmpl.template('formControlObjectTemplate')({
                        p:p,
                    ...
                    //key-value
                    controlTemplate = magicformTmpl.template('formControl'+type+'Template')({data:valin,p:p,options:options,listitem:additionnal});
                    if(options.tmplprocess){
                        controlTemplate = options.tmplprocess(controlTemplate);
                    }
            ...
            _translateJson:function(json, orders, options){
                ...
                panelTemplate = magicformTmpl.template('formPanelTemplate')({options:options});
                            ...
                            anchor.addEventListener("click", function() {
                                ...
                                if (newtemplate) {
                                    var elems = util.createElementsWithTemplate(
                                        magicformTmpl.template('formArrayControlItemTemplate')({
                                            editable:true,
